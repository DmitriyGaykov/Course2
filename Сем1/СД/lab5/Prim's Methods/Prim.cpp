...
int** CruskalaMethod()
{
	...
	map<pair<int, int>, bool> visitedEls;
	set<int> setVisited;
...
)
{
	...
	if (visited->find(el1) == visited->end())
	{
		visited->insert(el1);
...
//void checkLoops(int** ostTree)
//{
//	int temp;
//	int max;
//	int maxIndex = 0;
//	bool thereAreOnlyMax;
//	list<int> repeats;
//	set<int> path;
//
//	for (int i = 0; i < N; i++)
